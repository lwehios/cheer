...
const UUID = process.env.UUID || '80d5a50d-6a59-49a2-b871-4b2b9c2e3242'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreabf.mydommmmccccsss.dpdns.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYWRlZmY0NDE3ZWRhNDlmZTlmOThiOTk3Njc4N2E3MmIiLCJ0IjoiODZiYjg0OTMtNDhjYi00ZjMzLWEzNGYtMWY5MjhjZDRkODE1IiwicyI6Ik5tRTNNV016WlRNdE1qSmxOeTAwWVRCaExUZzJORFV0WXpSaVltUXdPVE15WTJSayJ9';
