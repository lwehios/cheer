...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'mydommmmccccsss.dpdns.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYWRlZmY0NDE3ZWRhNDlmZTlmOThiOTk3Njc4N2E3MmIiLCJ0IjoiYjI0NDgxOTgtNjEzNi00MTQzLWI3OGMtNjA2OTgyYmQyNTJhIiwicyI6Ik5XSTNNVEpsWW1FdFpHTmlNaTAwT0dJMUxXSXhNVGd0T1dVM01XWm1ZV1ZsWVRZNCJ9';
